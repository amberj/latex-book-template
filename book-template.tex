...
\begin{itemize}
\item A special word of thanks goes to Professor Don Knuth\footnote{\url{http://www-cs-faculty.stanford.edu/~uno/}} (for \TeX{}), Leslie Lamport\footnote{\url{http://www.lamport.org/}} (for \LaTeX{}).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Insert sample image                                                 %
% sample.png source: http://en.wikipedia.org/wiki/File:LaTeX_logo.svg %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.50]{sample.png}
\hspace{0.5in}\parbox{6in}{\caption{Sample image \label{box}}} 
\end{center} 
\end{figure}
